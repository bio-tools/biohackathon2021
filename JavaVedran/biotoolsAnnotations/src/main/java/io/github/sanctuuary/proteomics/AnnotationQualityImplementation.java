...
public class AnnotationQualityImplementation {
	...
	public static void loadData(String toolAnnotationDirPath, String resultsDirPath) throws IOException {
		List<String> toolAnnotationsDomain = Arrays.asList("toolAnnotationFullBioTools", "toolAnnotationMetabolomics", "toolAnnotationProteomics", "toolAnnotationOriginal");
		
		for (String toolsName : Utils.getElements(toolAnnotationsDomain, 4)) {
	 ...
	 * @throws IOException
	 */
	private static void evaluateAnnotations(String title, String toolAnnotations, String resultFilePath)
			throws IOException {
